...
import time
from _config import MODEL_DIR, TRAIN_DIR, TEST_DIR, RESULT_DIR, TEST_IMG_PATH
...
if __name__ == "__main__":
    ...
    example_image_path = TEST_IMG_PATH / "FU-athlete-foot_27.jpg"
    example_image_path = example_image_path.as_posix()

    # Uncomment the line below to train the model
    model_instance.train_model(data_directory, override=False)
